...
| DP-EP-03 | Inventory/enrichment y precedencia de fuentes | Puertos tipados, adaptador verificable, hechos con procedencia, conflictos y fallo requerido/opcional; sin inventar inventario desde el payload. |
