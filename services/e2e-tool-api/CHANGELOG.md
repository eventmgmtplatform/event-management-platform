...
- Endpoint aislado `registrar_blackout` para registrar y leer de vuelta ventanas
  SCHEDULED de 60 minutos por `customerCode` + `node`, con preset privado
  «Gestión de Blackouts» y herramientas internas desactivadas.
