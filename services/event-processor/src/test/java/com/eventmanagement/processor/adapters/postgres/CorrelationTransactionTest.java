...
class CorrelationTransactionTest {
    ...
    @BeforeAll static void database()throws Exception {
        ...
        try(var c=ds.getConnection();var s=c.createStatement()) {
            for(String file:List.of("009-event-processor.sql","010-processor-outbox-recovery.sql","011-processor-rule-registry.sql","013-processor-correlation.sql","013-processor-correlation.sql","014-processor-command-ledger.sql"))
