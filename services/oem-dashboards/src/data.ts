export const domains = {
  ...
  glpi: { title: "GLPI", short: "GLPI", unit: "Eventos con integración GLPI", description: "Estado y referencias de tickets GLPI.", checklist: ["Revisar resultados pendientes y fallidos", "Verificar el ID nativo de GLPI", "Revisar comandos pendientes de reconciliación"] },
