...
- Puente OpenAPI para ejecutar UC-001 desde OpenWebUI y consultar resultados:
  autenticación Bearer, comando fijo, exclusión de ejecuciones simultáneas,
  conservación de evidencia y bloqueo después de una interrupción. Incluye
  pruebas de autenticación, rechazo de comandos y reporte verificable.

- Kafka: pruebas de integridad, aislamiento y paridad del instalador; escenario real
  en candidato independiente con publicación/lectura y persistencia tras reinicio/recreación.
